...
export default createStore({
  ...
  actions: {
    ...
    async getFolders(context) {
      const response = await fetch('https://api.platform.sandbox.easytranslate.com/api/v1/teams/developer-account/folders', {
            method:'GET',
            headers: {
          ...
          context.commit('getFoldersMutation',responseData)
  ...
  mutations: {
   ...
   getFoldersMutation(state,value) {
    state.folders=value
   }
